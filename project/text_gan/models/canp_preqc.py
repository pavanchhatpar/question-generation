...
from ..layers import CANP_PreQC_Encoder
from ..features import NERTagger, PosTagger
from ..config import cfg


class CANP_PreQC(Model):
    def __init__(self,
                 vocab: Vocab,
                 ner: NERTagger,
                 pos: PosTagger,
                 **kwargs: Dict[str, Any]) -> None:
        super(CANP_PreQC, self).__init__(**kwargs)
        self.vocab = vocab
        copy_token = "@COPY@"
    ...
    def debug(self, cis, qit, ans, qpre, attn_weights, selective_weights):
